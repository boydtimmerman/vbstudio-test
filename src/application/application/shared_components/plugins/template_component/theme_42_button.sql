...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(9837830450639334)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9838165791639335)
,p_plugin_id=>wwv_flow_imp.id(9837830450639334)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9838461619639336)
,p_plugin_id=>wwv_flow_imp.id(9837830450639334)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9838722831639336)
,p_plugin_id=>wwv_flow_imp.id(9837830450639334)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9839016213639336)
,p_plugin_id=>wwv_flow_imp.id(9837830450639334)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9839387884639337)
,p_plugin_id=>wwv_flow_imp.id(9837830450639334)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9839643802639337)
,p_plugin_id=>wwv_flow_imp.id(9837830450639334)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9839941166639337)
,p_plugin_id=>wwv_flow_imp.id(9837830450639334)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9840268713639338)
,p_plugin_id=>wwv_flow_imp.id(9837830450639334)
,p_attribute_scope=>'COMPONENT'
