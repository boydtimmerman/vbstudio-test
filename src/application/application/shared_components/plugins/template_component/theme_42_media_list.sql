...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(9877554164639400)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1809895410737523051)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1809895965749523052)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9878273508639404)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9878543616639406)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9878807081639407)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9879127477639407)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9879480201639407)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9878807081639407)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1809895965749523052)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9879753663639408)
,p_plugin_attribute_id=>wwv_flow_imp.id(9879480201639407)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9880142298639408)
,p_plugin_attribute_id=>wwv_flow_imp.id(9879480201639407)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9880574462639408)
,p_plugin_attribute_id=>wwv_flow_imp.id(9879480201639407)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9880900409639409)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9879480201639407)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9881209003639409)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9881546323639409)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9881883435639410)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9882143679639410)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9882437616639411)
,p_plugin_attribute_id=>wwv_flow_imp.id(9882143679639410)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9882879179639411)
,p_plugin_attribute_id=>wwv_flow_imp.id(9882143679639410)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9883238221639411)
,p_plugin_attribute_id=>wwv_flow_imp.id(9882143679639410)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9883671391639412)
,p_plugin_attribute_id=>wwv_flow_imp.id(9882143679639410)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9884052756639412)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(9879127477639407)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1809895410737523051)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9884334117639412)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9884624469639413)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9884915581639413)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9885204757639413)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9885537208639414)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9885822827639414)
,p_plugin_attribute_id=>wwv_flow_imp.id(9885537208639414)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9886221484639415)
,p_plugin_attribute_id=>wwv_flow_imp.id(9885537208639414)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9886636669639415)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9886979711639416)
,p_plugin_attribute_id=>wwv_flow_imp.id(9886636669639415)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9887393856639416)
,p_plugin_attribute_id=>wwv_flow_imp.id(9886636669639415)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9887784123639417)
,p_plugin_attribute_id=>wwv_flow_imp.id(9886636669639415)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9888193833639417)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9889634422639419)
,p_plugin_attribute_id=>wwv_flow_imp.id(9888193833639417)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9890065142639419)
,p_plugin_attribute_id=>wwv_flow_imp.id(9888193833639417)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9888447230639417)
,p_plugin_attribute_id=>wwv_flow_imp.id(9888193833639417)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9888814200639418)
,p_plugin_attribute_id=>wwv_flow_imp.id(9888193833639417)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9889227116639418)
,p_plugin_attribute_id=>wwv_flow_imp.id(9888193833639417)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9890449005639420)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9890770933639420)
,p_plugin_attribute_id=>wwv_flow_imp.id(9890449005639420)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9891126049639420)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1810099017906669680)
,p_plugin_id=>wwv_flow_imp.id(9877554164639400)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
