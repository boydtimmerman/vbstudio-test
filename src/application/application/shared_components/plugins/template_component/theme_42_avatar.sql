...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(9822696354639306)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9822979775639309)
,p_plugin_id=>wwv_flow_imp.id(9822696354639306)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9823235166639310)
,p_plugin_attribute_id=>wwv_flow_imp.id(9822979775639309)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9823657814639311)
,p_plugin_attribute_id=>wwv_flow_imp.id(9822979775639309)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9824040337639312)
,p_plugin_attribute_id=>wwv_flow_imp.id(9822979775639309)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9824430139639313)
,p_plugin_id=>wwv_flow_imp.id(9822696354639306)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9822979775639309)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9824757233639313)
,p_plugin_id=>wwv_flow_imp.id(9822696354639306)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9825088710639314)
,p_plugin_id=>wwv_flow_imp.id(9822696354639306)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9825388614639314)
,p_plugin_id=>wwv_flow_imp.id(9822696354639306)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9825658715639314)
,p_plugin_id=>wwv_flow_imp.id(9822696354639306)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9825903967639315)
,p_plugin_attribute_id=>wwv_flow_imp.id(9825658715639314)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9826350445639315)
,p_plugin_attribute_id=>wwv_flow_imp.id(9825658715639314)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9826762151639315)
,p_plugin_attribute_id=>wwv_flow_imp.id(9825658715639314)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9827155746639316)
,p_plugin_attribute_id=>wwv_flow_imp.id(9825658715639314)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9827555003639316)
,p_plugin_id=>wwv_flow_imp.id(9822696354639306)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9827833949639317)
,p_plugin_attribute_id=>wwv_flow_imp.id(9827555003639316)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9828200737639317)
,p_plugin_attribute_id=>wwv_flow_imp.id(9827555003639316)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9828629698639317)
,p_plugin_attribute_id=>wwv_flow_imp.id(9827555003639316)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9829080380639318)
,p_plugin_attribute_id=>wwv_flow_imp.id(9827555003639316)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9829416267639318)
,p_plugin_attribute_id=>wwv_flow_imp.id(9827555003639316)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9829834010639318)
,p_plugin_attribute_id=>wwv_flow_imp.id(9827555003639316)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9830206019639319)
,p_plugin_attribute_id=>wwv_flow_imp.id(9827555003639316)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9830630205639319)
,p_plugin_id=>wwv_flow_imp.id(9822696354639306)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1809873537632753060)
,p_plugin_id=>wwv_flow_imp.id(9822696354639306)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
