...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9647852365639202)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9648199403639202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9648446281639203)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9648789714639203)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9649080782639203)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9649398499639203)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9649685918639203)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9649941180639203)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9650222037639203)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9650525970639204)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9650836704639204)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9651154876639204)
,p_page_template_id=>wwv_flow_imp.id(9647852365639202)
