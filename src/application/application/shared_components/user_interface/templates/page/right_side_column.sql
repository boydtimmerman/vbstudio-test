...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9651510040639204)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9651888773639205)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9652183325639205)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9652434663639205)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9652736613639205)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9653047918639205)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9653303314639205)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9653634364639205)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9653917096639205)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9654268535639206)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9654529454639206)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9654840710639206)
,p_page_template_id=>wwv_flow_imp.id(9651510040639204)
