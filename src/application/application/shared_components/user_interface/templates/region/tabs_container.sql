...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9757260660639261)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9757583753639261)
,p_plug_template_id=>wwv_flow_imp.id(9757260660639261)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9757891141639261)
,p_plug_template_id=>wwv_flow_imp.id(9757260660639261)
,p_name=>'Tabs'
