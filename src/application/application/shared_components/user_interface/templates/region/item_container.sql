...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9739731835639253)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9740007965639253)
,p_plug_template_id=>wwv_flow_imp.id(9739731835639253)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9740371015639253)
,p_plug_template_id=>wwv_flow_imp.id(9739731835639253)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9740690875639254)
,p_plug_template_id=>wwv_flow_imp.id(9739731835639253)
,p_name=>'Button Start'
