...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9707826603639238)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9708104240639238)
,p_plug_template_id=>wwv_flow_imp.id(9707826603639238)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9708420559639238)
,p_plug_template_id=>wwv_flow_imp.id(9707826603639238)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9708744171639239)
,p_plug_template_id=>wwv_flow_imp.id(9707826603639238)
,p_name=>'Sub Regions'
