...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9724180617639245)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9724458237639246)
,p_plug_template_id=>wwv_flow_imp.id(9724180617639245)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9724708096639246)
,p_plug_template_id=>wwv_flow_imp.id(9724180617639245)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9725090107639246)
,p_plug_template_id=>wwv_flow_imp.id(9724180617639245)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9725300850639246)
,p_plug_template_id=>wwv_flow_imp.id(9724180617639245)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9725633274639247)
,p_plug_template_id=>wwv_flow_imp.id(9724180617639245)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
