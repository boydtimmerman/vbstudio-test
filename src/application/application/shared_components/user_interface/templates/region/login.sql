...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9742256364639254)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9742580099639254)
,p_plug_template_id=>wwv_flow_imp.id(9742256364639254)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9742831167639255)
,p_plug_template_id=>wwv_flow_imp.id(9742256364639254)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9743148413639255)
,p_plug_template_id=>wwv_flow_imp.id(9742256364639254)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9743477949639255)
,p_plug_template_id=>wwv_flow_imp.id(9742256364639254)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9743779549639255)
,p_plug_template_id=>wwv_flow_imp.id(9742256364639254)
,p_name=>'Sub Regions'
