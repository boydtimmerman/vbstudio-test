...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9732265445639250)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9732579966639250)
,p_plug_template_id=>wwv_flow_imp.id(9732265445639250)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9732848219639250)
,p_plug_template_id=>wwv_flow_imp.id(9732265445639250)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9733101923639250)
,p_plug_template_id=>wwv_flow_imp.id(9732265445639250)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9733405466639250)
,p_plug_template_id=>wwv_flow_imp.id(9732265445639250)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9733700808639250)
,p_plug_template_id=>wwv_flow_imp.id(9732265445639250)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9734060724639250)
,p_plug_template_id=>wwv_flow_imp.id(9732265445639250)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9734367183639250)
,p_plug_template_id=>wwv_flow_imp.id(9732265445639250)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9734697397639251)
,p_plug_template_id=>wwv_flow_imp.id(9732265445639250)
,p_name=>'Sub Regions'
