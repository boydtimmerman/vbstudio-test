...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9727646705639247)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9727973469639248)
,p_plug_template_id=>wwv_flow_imp.id(9727646705639247)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9728239427639248)
,p_plug_template_id=>wwv_flow_imp.id(9727646705639247)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9728524012639248)
,p_plug_template_id=>wwv_flow_imp.id(9727646705639247)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9728840143639248)
,p_plug_template_id=>wwv_flow_imp.id(9727646705639247)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9729109507639248)
,p_plug_template_id=>wwv_flow_imp.id(9727646705639247)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9729471278639248)
,p_plug_template_id=>wwv_flow_imp.id(9727646705639247)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9729726988639248)
,p_plug_template_id=>wwv_flow_imp.id(9727646705639247)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9730019035639248)
,p_plug_template_id=>wwv_flow_imp.id(9727646705639247)
,p_name=>'Sub Regions'
