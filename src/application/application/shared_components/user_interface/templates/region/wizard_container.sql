...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9764990531639265)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9765273825639265)
,p_plug_template_id=>wwv_flow_imp.id(9764990531639265)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9765565326639265)
,p_plug_template_id=>wwv_flow_imp.id(9764990531639265)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9765821414639265)
,p_plug_template_id=>wwv_flow_imp.id(9764990531639265)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9766123562639265)
,p_plug_template_id=>wwv_flow_imp.id(9764990531639265)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9766407720639265)
,p_plug_template_id=>wwv_flow_imp.id(9764990531639265)
