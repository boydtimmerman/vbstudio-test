...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9714339471639241)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714633992639241)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9714965994639241)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9715200560639241)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9715569766639242)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9715847495639242)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9716131316639242)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9716466674639242)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9716788136639242)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9717048091639242)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9717390029639242)
,p_plug_template_id=>wwv_flow_imp.id(9714339471639241)
,p_name=>'Sub Regions'
