...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9709725122639239)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9710060557639239)
,p_plug_template_id=>wwv_flow_imp.id(9709725122639239)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9710314370639239)
,p_plug_template_id=>wwv_flow_imp.id(9709725122639239)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9710696091639239)
,p_plug_template_id=>wwv_flow_imp.id(9709725122639239)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9710948946639240)
,p_plug_template_id=>wwv_flow_imp.id(9709725122639239)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9711228642639240)
,p_plug_template_id=>wwv_flow_imp.id(9709725122639239)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9711593098639240)
,p_plug_template_id=>wwv_flow_imp.id(9709725122639239)
,p_name=>'Sub Regions'
