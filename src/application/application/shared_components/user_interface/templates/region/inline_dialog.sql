...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9699141187639234)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9699455178639234)
,p_plug_template_id=>wwv_flow_imp.id(9699141187639234)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9699764684639234)
,p_plug_template_id=>wwv_flow_imp.id(9699141187639234)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9700002853639234)
,p_plug_template_id=>wwv_flow_imp.id(9699141187639234)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9700328233639234)
,p_plug_template_id=>wwv_flow_imp.id(9699141187639234)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9700665006639235)
,p_plug_template_id=>wwv_flow_imp.id(9699141187639234)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9700973676639235)
,p_plug_template_id=>wwv_flow_imp.id(9699141187639234)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9701244653639235)
,p_plug_template_id=>wwv_flow_imp.id(9699141187639234)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9701529036639235)
,p_plug_template_id=>wwv_flow_imp.id(9699141187639234)
,p_name=>'Sub Regions'
