...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9737619148639252)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9737965084639252)
,p_plug_template_id=>wwv_flow_imp.id(9737619148639252)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9738250550639253)
,p_plug_template_id=>wwv_flow_imp.id(9737619148639252)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9738559301639253)
,p_plug_template_id=>wwv_flow_imp.id(9737619148639252)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9738807184639253)
,p_plug_template_id=>wwv_flow_imp.id(9737619148639252)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9739131685639253)
,p_plug_template_id=>wwv_flow_imp.id(9737619148639252)
,p_name=>'Sub Regions'
