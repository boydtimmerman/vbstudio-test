...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9693719983639231)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9694001784639231)
,p_plug_template_id=>wwv_flow_imp.id(9693719983639231)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9694397849639231)
,p_plug_template_id=>wwv_flow_imp.id(9693719983639231)
,p_name=>'Sub Regions'
