...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9744757851639255)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9745028486639255)
,p_plug_template_id=>wwv_flow_imp.id(9744757851639255)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9745388350639256)
,p_plug_template_id=>wwv_flow_imp.id(9744757851639255)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9745678415639256)
,p_plug_template_id=>wwv_flow_imp.id(9744757851639255)
,p_name=>'Sub Regions'
