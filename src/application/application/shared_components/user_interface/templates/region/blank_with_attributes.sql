...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9680852476639224)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9681113575639224)
,p_plug_template_id=>wwv_flow_imp.id(9680852476639224)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9681431867639224)
,p_plug_template_id=>wwv_flow_imp.id(9680852476639224)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9681747493639224)
,p_plug_template_id=>wwv_flow_imp.id(9680852476639224)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9682029653639224)
,p_plug_template_id=>wwv_flow_imp.id(9680852476639224)
,p_name=>'Sub Regions'
