...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9682249606639224)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9682502721639225)
,p_plug_template_id=>wwv_flow_imp.id(9682249606639224)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9682812367639225)
,p_plug_template_id=>wwv_flow_imp.id(9682249606639224)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9683122800639225)
,p_plug_template_id=>wwv_flow_imp.id(9682249606639224)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9683488872639225)
,p_plug_template_id=>wwv_flow_imp.id(9682249606639224)
,p_name=>'Sub Regions'
