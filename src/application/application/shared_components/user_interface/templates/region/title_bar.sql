...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9759884189639262)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760186116639262)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760449145639263)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9760745740639263)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9761001602639263)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9761307187639263)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9761695412639263)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9761971504639263)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9762268792639263)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9762530976639264)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9762871007639264)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9763199994639264)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9763494107639264)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9763738075639264)
,p_plug_template_id=>wwv_flow_imp.id(9759884189639262)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
